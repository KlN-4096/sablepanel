...
const I18N = {
  zh: {
    ...
    voidTag:'整体在世界底之下,玩家无法到达', voidBadge:'虚空',
    skyTag:'整体在建筑高度上限之上,玩家无法到达', skyBadge:'极高空',
  ...
  en: {
    ...
    voidTag:'entirely below the world floor, unreachable', voidBadge:'void',
    skyTag:'entirely above the build limit, unreachable', skyBadge:'far above',
