...
const I18N = {
  zh: {
    ...
    pickBody:'选择一个物理体查看详情', teleportTo:'传送到', adopt:'收养找回(含依赖)',
    ...
    tpPlayerBtn:'传送玩家到此', tpNoPlayers:'没有在线玩家', tpPlayerT:'传送玩家',
  ...
  en: {
    ...
    pickBody:'Select a body to view details', teleportTo:'Teleport to', adopt:'Adopt & recover (with deps)',
    ...
    tpPlayerBtn:'Teleport player here', tpNoPlayers:'No players online', tpPlayerT:'Teleport player',
