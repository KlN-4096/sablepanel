...
final class BoundedNbtIo {
    static final long MAX_COMPRESSED_BYTES = 64L << 20;
    private static final long MAX_ACCOUNTED_BYTES = 128L << 20;

    private BoundedNbtIo() {
    }

    static CompoundTag readCompressed(Path file) throws IOException {
    ...
    static CompoundTag readCompressed(byte[] payload) throws IOException {
    ...
    static void requireCompressedSize(Path file) throws IOException {
