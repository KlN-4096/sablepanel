...
public final class ClientPanelConfig {
    ...
    public static final String DEFAULT_ADDRESS = "localhost:25581";
    private transient Path configFile;
    public int webPort = 25580;
    public String lastAddress = DEFAULT_ADDRESS;
    ...
    static ClientPanelConfig load(Path file) {
        try {
            ...
            if (config.lastAddress == null || config.lastAddress.isBlank()) {
                config.lastAddress = DEFAULT_ADDRESS;
            }
